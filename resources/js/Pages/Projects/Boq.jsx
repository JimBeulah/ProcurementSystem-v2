                                            ...
                                            <td className="py-3 px-2 text-center" onClick={e => e.stopPropagation()}>
                                                <div className="flex items-center justify-center gap-1.5">
                                                    <button
                                                        ...
                                                        title="Edit Item"
                                                        className="p-1.5 rounded-lg transition-all border shadow-sm hover:shadow active:scale-95 bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400 hover:bg-cyan-100 dark:hover:bg-cyan-800/30 hover:text-cyan-700 dark:hover:text-cyan-300 border-cyan-200/50 dark:border-cyan-700/30"
                                                    >
                                                        <Pencil size={14} />
                                                    </button>
                                                    <button
                                                        ...
                                                        title="Delete Item"
                                                        className="p-1.5 rounded-lg transition-all border shadow-sm hover:shadow active:scale-95 bg-red-50 dark:bg-red-900/20 text-red-500 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-800/30 hover:text-red-700 dark:hover:text-red-300 border-red-200/50 dark:border-red-700/30"
                                                    >
                                                        <Trash2 size={14} />
                                                    </button>
                                                </div>
                                        ...
                                        <div key={comp.id} className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 rounded-xl p-4 shadow-sm group hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                                            <div className="flex items-start justify-between mb-3">
                                                ...
                                                <div className="flex items-center gap-1 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button
                                                        onClick={() => setResourceModal({ open: true, mode: 'edit', data: comp })}
                                                        className="p-1.5 rounded-md transition-all text-slate-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 hover:text-cyan-600"
                                                        title="Edit Resource"
                                                    >
                                                        <Pencil size={12} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className="p-1.5 rounded-md transition-all text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500"
                                                        title="Delete Resource"
                                                    >
                                                        <Trash2 size={12} />
                                                    </button>
