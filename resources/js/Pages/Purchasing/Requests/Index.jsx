...
import {
    ...
    Briefcase, Calendar, User, DollarSign, AlertTriangle, Package
} from 'lucide-react';
                                                    ...
                                                    <div className="flex items-center justify-center gap-1">
                                                        {pr.status === 'PENDING' && (
                                                            <>
                                                                ...
                                                                <button onClick={() => handleDecline(pr.id)} title="Decline" className="p-1.5 text-slate-400 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-colors">
                                                                    <XCircle size={16} />
                                                                </button>
                                                            </>
                                                        )}
