...
import { ShoppingCart, Plus, Calendar, MapPin, Package, Printer, CheckCircle } from 'lucide-react';
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className={`px-3 py-1 rounded-full text-xs font-bold border max-w-max ${po.status === 'APPROVED' ? 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' :
