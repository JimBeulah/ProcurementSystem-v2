...
export function StatCard({ title, value, icon, trend, color }) {
    return (
        <Card className="relative overflow-hidden group bg-white/40 dark:bg-zinc-900/40 backdrop-blur-2xl border-white/20 dark:border-white/5 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl sm:rounded-3xl p-4 sm:p-5">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                    <h3 className="text-2xl sm:text-3xl font-bold mb-1 tracking-tight text-zinc-900 dark:text-zinc-100 font-sans">{value}</h3>
